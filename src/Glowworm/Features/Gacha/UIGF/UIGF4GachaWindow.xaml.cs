...
public sealed partial class UIGF4GachaWindow : WindowEx
{
    ...
    private void InitializeWindow()
    {
        ...
        Title = "Gacha Records Import / Export";        RootGrid.RequestedTheme = ShouldAppsUseDarkMode() ? ElementTheme.Dark : ElementTheme.Light;
    ...
    private async Task ExportAsync()
    {
        try
        {
            ...
            {
                string name = $"Glowworm_UIGF_{DateTimeOffset.Now:yyyyMMdd_HHmmss}.json";
