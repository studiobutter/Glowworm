...
namespace Glowworm.Features.Gacha.ZZZGachaToolbox;
...
public sealed partial class ZZZGachaInfoWindow : WindowEx
{
    ...
    private void InitializeWindow()
    {
        ...
        Title = "ZZZ Gacha Item Images";        RootGrid.RequestedTheme = ShouldAppsUseDarkMode() ? ElementTheme.Dark : ElementTheme.Light;
