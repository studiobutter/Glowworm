...
public sealed partial class HotkeyInput : UserControl
{
    ...
    {
        this.Unloaded -= HotkeyInput_Unloaded;
        Button_EditHotkey.Click -= Button_EditHotkey_Click;
        Grid_EditHotkey.LostFocus -= Grid_EditHotkey_LostFocus;
        Grid_EditHotkey.KeyDown -= Grid_EditHotkey_KeyDown;
        Grid_EditHotkey.KeyUp -= Grid_EditHotkey_KeyUp;
    ...
    private void UpdateText()
    {
        ...
        EditingText = GetHotkeyText(_editingModifiers, _editingKey) ?? "";
    }
