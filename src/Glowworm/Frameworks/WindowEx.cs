...
public abstract partial class WindowEx : Window
{
    ...
    public WindowEx()
    {
        ...
        if (InputSiteHandle != IntPtr.Zero)
        {
    ...
    {
        ComCtl32.RemoveWindowSubclass(WindowHandle, windowSubclassProc, 1001);
        if (InputSiteHandle != IntPtr.Zero)
        {
            ComCtl32.RemoveWindowSubclass(InputSiteHandle, inputSiteSubclassProc, 1002);
        }
    }
