...
public class DownloadService
{
    ...
    protected void RecreateHttpClient()
    {
        ...
        _httpClient.DefaultRequestHeaders.Add("User-Agent", $"Glowworm.Setup/{ver}");
    ...
    {
        if (Path.Combine(installFolder, "Glowworm.Setup.exe") != Environment.ProcessPath)
        {
            Directory.CreateDirectory(installFolder);
            File.Copy(Environment.ProcessPath!, Path.Combine(installFolder, "Glowworm.Setup.exe"), true);
        }
    }
